...
// FIX: Corrected the include path. Assuming db_conn.php is in /config/
...
// Removed 'phone' from the initial array as the column does not exist.
$user = ['name' => '', 'email' => '']; 

// *** CORRECTED: Removed 'phone' from the SELECT query ***
